import { deleteVideoHandler, getAllVideosHandler, searchVideoHandler, streamVideoHandler, updateVideoHandler, uploadVideoHandler } from "@src/controllers/video.controller";
